      ...
      <div className="bg-gray-50 sticky top-0 z-50 dark:bg-darkNav transition-colors duration-500">
        <div className="max-w-screen-xl px-5 mx-auto">
          <nav className="flex py-4 justify-between items-center">
            <Link href="/">
              <a className="focus:outline-none font-signika hover:text-gray-600 text-lg font-bold text-gray-500 dark:text-gray-400 dark:hover:text-gray-100 transition-colors duration-500">
